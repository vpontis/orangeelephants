...
//blockers have separate functions because one motor-operated and the other is servo-operated
void lowerBlockerLeft(){			//lower left blocker and move forward 20cm (subject to change)
...
{
	//axle length (LEGOBOT_DIAMETER) is 13.75 cm
...
/*
        -brief Rotates legobot using a wheel as a pivot point
        -param True if using left wheel as pivot, false if using right wheel
        -param degrees Tells robot how much of the circle to turn in degrees
		-param speed Sets speed of the wheel that moves
*/
